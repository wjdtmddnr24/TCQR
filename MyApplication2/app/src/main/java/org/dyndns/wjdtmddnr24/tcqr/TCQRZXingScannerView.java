...
public class TCQRZXingScannerView extends BarcodeScannerView {
    private static final String TAG = "ZXingScannerView";
    private MultiFormatReader mMultiFormatReader;
    public static final List<BarcodeFormat> ALL_FORMATS = new ArrayList();
    private List<BarcodeFormat> mFormats;
    private TCQRZXingScannerView.ResultHandler mResultHandler;

    public TCQRZXingScannerView(Context context) {
        super(context);
        this.initMultiFormatReader();
    }

    public TCQRZXingScannerView(Context context, AttributeSet attributeSet) {
    ...
    public void setResultHandler(TCQRZXingScannerView.ResultHandler resultHandler) {
        ...
        if(this.mResultHandler != null) {
            try {
                ...
                if(var22 != null) {
                    ...
                    Result finalVar2 = var22;
                    handler.post(new Runnable() {
                        public void run() {
                            TCQRZXingScannerView.ResultHandler tmpResultHandler = TCQRZXingScannerView.this.mResultHandler;
                            TCQRZXingScannerView.this.mResultHandler = null;
                            TCQRZXingScannerView.this.stopCameraPreview();
    ...
    public void resumeCameraPreview(TCQRZXingScannerView.ResultHandler resultHandler) {
        this.mResultHandler = resultHandler;
